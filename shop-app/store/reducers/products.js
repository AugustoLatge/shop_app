...
export default (state = initialState, action) => {
  switch(action.type) {
    ...
    case UPDATE_PRODUCT:
      ...
      const updatedProduct = new Product(action.pid, state.userProducts[userProductIndex].ownerId, action.productData.title, action.productData.imageUrl, action.productData.description, state.userProducts[userProductIndex].price);
